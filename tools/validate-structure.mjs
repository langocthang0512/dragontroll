...
const requiredFiles = [
  ...
  "src/editor/DeveloperToolkit.ts",
  "src/editor/EditorCanvasView.ts",
  "src/editor/assets/AssetCatalog.ts",
  "src/editor/maps/EditorMap.ts",
  "src/editor/maps/map1Document.ts",
  "src/editor/library/EditorHistory.ts",
  "src/editor/library/EditorStorage.ts",
  "src/editor/presets/index.ts",
  "src/editor/templates/index.ts",
  "docs/editor-toolkit.md",
